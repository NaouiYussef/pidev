package com.example.pidev.Security;


import com.example.pidev.Filtre.CustomAuthenticationFilter;
import com.example.pidev.Filtre.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests().antMatchers("/login/**","/user/add").permitAll();
//        //juste pour le test
